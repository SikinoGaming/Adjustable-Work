 ...
 *
 */
package net.mcreator.adjustablework;
...
import net.mcreator.adjustablework.init.AdjustableWorkModSounds;
...
@Mod("adjustable_work")
public class AdjustableWorkMod {
	public static final Logger LOGGER = LogManager.getLogger(AdjustableWorkMod.class);
	public static final String MODID = "adjustable_work";

	public AdjustableWorkMod() {
		...
		AdjustableWorkModMenus.REGISTRY.register(bus);
