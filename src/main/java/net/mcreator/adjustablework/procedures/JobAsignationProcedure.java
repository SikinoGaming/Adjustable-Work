...
public class JobAsignationProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (AdjustableWorkModVariables.MapVariables.get(world).HasAlreadyJoin == 0) {
			AdjustableWorkModVariables.MapVariables.get(world).HasAlreadyJoin = 1;
